...
export const JOURNEY_REVIEWED_AT = '2026-09-18'
...
export const journeySources: JourneySource[] = [
  ...
  { id: 'book-rework', title: 'Publisher: October 19, 2021 professions patch', url: 'https://www.playneverwinter.com/en/news-details/11500323', publishedAt: '2021-10-19', reviewedAt: JOURNEY_REVIEWED_AT, kind: 'publisher', limitation: 'Documents a 500,000 AD Stronghold book baseline and a 1,500,000 AD Sharandar book baseline, ordered per-profession purchases and removal of the old Artisan storyline. It renames IV/V to Chultan Masterwork but does not independently certify every Chultan/Menzoberranzan price, current binding, guild-rank eligibility or discounts.' },
  ...
  { id: 'chultan-field-guide', title: 'New OutRiders: Chultan Masterwork weapon field guide', url: 'https://newoutriders.org/2023/01/13/temple-of-the-spider-queen-and-masterwork-weapons/', publishedAt: '2023-01-13', reviewedAt: JOURNEY_REVIEWED_AT, kind: 'community', limitation: 'Records Level 20 in the desired profession, Chultan I then II purchases at the Stronghold and the cross-profession material network. Its recommendation to level all seven describes self-producing the weapon ingredients; it is not treated as a universal vendor gate in 2026.' },
...
export const journeyPhases: JourneyPhase[] = [
  ...
  },
  {
    ...
    sections: [
      { title: 'What the 2023 field route corroborates', paragraphs: ['A January 2023 crafter guide records the practical sequence as profession Level 20, purchase Chultan I in the Stronghold, then purchase Chultan II in that same field. That agrees with the publisher’s ordered-book model.', 'The same guide says a self-sufficient Chultan weapon crafter needs all seven professions because the weapon chains consume manufactured ingredients from multiple professions. This is a production dependency statement, not proof that the vendor universally requires all seven books before one profession can progress.'], sourceIds: ['chultan-field-guide', 'book-rework'] },
    ...
    caution: 'Current guild rank requirements and Chultan pack binding remain unverified. Check the exact listing instead of relying on an old rank-10/12/14 guild rule.', sourceIds: ['book-rework', 'chultan-field-guide', 'sharandar-demonstration'],
  },
  {
