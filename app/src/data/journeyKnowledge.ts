...
export const journeySources: JourneySource[] = [
  ...
  { id: 'book-rework', title: 'Publisher: October 19, 2021 professions patch', url: 'https://www.playneverwinter.com/en/news-details/11500323', publishedAt: '2021-10-18', reviewedAt: JOURNEY_REVIEWED_AT, kind: 'publisher', limitation: 'Documents ordered book purchases, listed prices and removal of the old Artisan storyline. Current vendor eligibility is not fully specified.' },
