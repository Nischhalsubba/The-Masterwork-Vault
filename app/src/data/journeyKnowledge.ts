...
export const journeySources: JourneySource[] = [
  ...
  { id: 'book-rework', title: 'Publisher: October 19, 2021 professions patch', url: 'https://www.playneverwinter.com/en/news-details/11500323', publishedAt: '2021-10-19', reviewedAt: JOURNEY_REVIEWED_AT, kind: 'publisher', limitation: 'Documents 500,000 AD Stronghold/Chultan and 1,500,000 AD Sharandar book baselines, ordered per-profession purchases and removal of the old Artisan storyline. It does not certify 2026 binding, guild-rank eligibility, discounts or Menzoberranzan pricing.' },
