...
export const sharandarRecipes: SharandarRecipe[] = [
  ...
  { name: 'Fey Fibers', outputQuantity: 1, quantityExplicit: false, materials: [{ name: 'Dryad Hair', required: 12 }, { name: "Weeping Willow's Tears", required: 6 }], evidence: [...e('Recipes General/16.png'), 'Output quantity is not visible in the supplied crop; a separate task-table source is required for the yield.'] },
...
const sharandarWiki = {
  alchemy: 'https://neverwinter.fandom.com/ru/wiki/%D0%9C%D0%B0%D1%81%D1%82%D0%B5%D1%80%D1%81%D0%BA%D0%B8%D0%B5_%D1%80%D0%B5%D1%86%D0%B5%D0%BF%D1%82%D1%8B_%D0%B0%D0%BB%D1%85%D0%B8%D0%BC%D0%B8%D0%B8',
  blacksmithing: 'https://neverwinter.fandom.com/ru/wiki/%D0%9C%D0%B0%D1%81%D1%82%D0%B5%D1%80%D1%81%D0%BA%D0%B8%D0%B5_%D1%80%D0%B5%D1%86%D0%B5%D0%BF%D1%82%D1%8B_%D0%BA%D1%83%D0%B7%D0%BD%D0%B5%D1%87%D0%BD%D0%BE%D0%B3%D0%BE_%D0%B4%D0%B5%D0%BB%D0%B0',
...
const wikiYield = (outputQuantity:number, sourceUrl:string): SharandarYieldEvidence => ({
  outputQuantity,
  sourceUrl,
  sourceLabel: 'Neverwinter Wiki — localized Sharandar Masterwork task table',
  reviewedAt: '2026-09-18',
  limitation: 'Community-maintained task table, not a live-server capture. English screenshot identity is cross-checked against the localized task row; live recipe UI wins if it differs.',
})

export const sharandarYieldEvidence: Record<string, SharandarYieldEvidence> = {
  'Fey Fibers': wikiYield(1, sharandarWiki.tailoring),
  'Feywood Broad Slab': wikiYield(1, sharandarWiki.blacksmithing),
  "Fey'd Leaf Sword Knot": wikiYield(1, sharandarWiki.tailoring),
  'Feywood Lute': wikiYield(1, sharandarWiki.artificing),
  'Feywood Rapier': wikiYield(1, sharandarWiki.blacksmithing),
  'Silvervine Sceptor': wikiYield(1, sharandarWiki.artificing),
  'Frozen Dew Icon': wikiYield(1, sharandarWiki.artificing),
  'Feywood Carved Blade': wikiYield(1, sharandarWiki.blacksmithing),
  'Feywood Club': wikiYield(1, sharandarWiki.blacksmithing),
  'Feywood Longbow': wikiYield(1, sharandarWiki.artificing),
  'Feywood Blades': wikiYield(1, sharandarWiki.blacksmithing),
  'Feywood Stiletto': wikiYield(1, sharandarWiki.blacksmithing),
  'Feywood Dagger': wikiYield(1, sharandarWiki.blacksmithing),
  'Feywood Pact Blade': wikiYield(1, sharandarWiki.artificing),
  'Petrified Grimoire': wikiYield(1, sharandarWiki.artificing),
  'Silvervine Orb': wikiYield(1, sharandarWiki.artificing),
  'Thorned Talisman': wikiYield(1, sharandarWiki.artificing),
  'Lacquered Leaf Waders': wikiYield(1, sharandarWiki.leatherworking),
  'Petrified Braces': wikiYield(1, sharandarWiki.leatherworking),
  'Petrified Wraps': wikiYield(1, sharandarWiki.leatherworking),
  'Petrified Wristlets': wikiYield(1, sharandarWiki.leatherworking),
  "Fey'd Leaf Branches": wikiYield(1, sharandarWiki.tailoring),
  'Petrified Bark Barbute': wikiYield(1, sharandarWiki.leatherworking),
  'Sprouting Crown': wikiYield(1, sharandarWiki.leatherworking),
  "Fey'd Leaf Wood Crown": wikiYield(1, sharandarWiki.tailoring),
  'Crafted Potion of Accuracy Rank 13': wikiYield(12, sharandarWiki.alchemy),
  'Crafted Potion of Critical Strike Rank 13': wikiYield(12, sharandarWiki.alchemy),
  'Crafted Potion of Defense Rank 13': wikiYield(12, sharandarWiki.alchemy),
  'Crafted Potion of Deflect Rank 13': wikiYield(12, sharandarWiki.alchemy),
  'Crafted Potion of Power Rank 13': wikiYield(12, sharandarWiki.alchemy),
}

for (const recipe of sharandarRecipes) {
  const evidence = sharandarYieldEvidence[recipe.name]
  if (!evidence) continue
  recipe.outputQuantity = evidence.outputQuantity
  recipe.quantityExplicit = true
  recipe.evidence = Array.from(new Set([
    ...recipe.evidence,
    `${evidence.sourceLabel} · recorded result ×${evidence.outputQuantity} · reviewed ${evidence.reviewedAt} · ${evidence.sourceUrl}`,
    evidence.limitation,
  ]))
}
